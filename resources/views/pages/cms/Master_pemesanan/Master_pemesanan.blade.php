    ...
    <div class="main maen">
          <div class="col-sm-12">
            <div class="row">
              ...
              <h3 class="matop-80">Transaksi Pemesanan</h3>
                ...
                <table class="table text-center" id=""  width="100%" cellspacing="0">
                    ...
                    <tbody class="text-center" id="">
                              ...
                              <div class="detail-popup col-sm-12 botom-detail text-center">
                                <div class="row">                               
                                  <div class="iframe"  scrolling="yes">
                                      ...
                                      <table class="marbon table text-center tabel" style="margin-bottom: 10px"  width="100%" cellspacing="0">
                                        ...
                                        <tbody id="">
                                          <tr>
                                            ...
                                            <td>Rp. 5.000.000</td>
                                            <td>
                                              <a class="collapsed" href="#pesan1-1" id="more" data-toggle="collapse">
                                    ...
                                    <div id="pesan1-1" class="collapse">
                                      ...
                                      <table class="table text-center tabel"  width="100%" cellspacing="0">
                                        ...
                                        <tbody id="">
                                          <tr>
                                            ...
                                            <td>Rp. 8.000.000</td>
                                            <td>
                                              <a class="collapsed" href="#pesan1-2" id="more" data-toggle="collapse">
                                                <span class="if-collapsed">BUKA</span>
                                                <span class="if-not-collapsed">TUTUP</span>
                                              </a>
                                            </td>
                                    ...
                                    <div id="pesan1-2" class="collapse">
                                      <div class="bungkus-detail" style="margin-bottom: 1rem">
                                        <div class="isi-detail">
                                          <div class="row">
                                            <div class="col-sm-6">
                      ...
                      <tr>
                        ...
                        <td class="padding-td mobilehide-list tabhide-list">200gr</td>
                        <td class="padding-td mobilehide-list tabhide-list">24</td>
                        <td class="padding-td hide-list">Rp. 18.000.000</td>
                        <td class="padding-td mobilehide-list tabhide-list">Samsudin</td>
                              ...
                              <div class="detail-popup col-sm-12 botom-detail text-center">
                                <div class="row">                               
                                  <div class="iframe"  scrolling="yes">
                                      ...
                                      <table class="marbon table text-center tabel"  width="100%" cellspacing="0">
                                        ...
                                        <tbody id="">
                                          <tr>
                                            ...
                                            <td>Rp. 5.000.000</td>
                                            <td>
                                              <a class="collapsed" href="#pesan2-1" id="more" data-toggle="collapse">
                                                <span class="if-collapsed">BUKA</span>
                                                <span class="if-not-collapsed">TUTUP</span>
                                              </a>
                                            </td>
                                    ...
                                    <div id="pesan2-1" class="collapse">
                                      <div class="bungkus-detail" style="margin-bottom: 1rem">
                                        <div class="isi-detail">
                                          <div class="row">
                                            <div class="col-sm-6">
                                      ...
                                      <table class="table text-center tabel"  width="100%" cellspacing="0">
                                        ...
                                        <tbody id="">
                                          <tr>
                                            ...
                                            <td>Rp. 8.000.000</td>
                                            <td>
                                              <a class="collapsed" href="#pesan2-2" id="more" data-toggle="collapse">
                                                <span class="if-collapsed">BUKA</span>
                                                <span class="if-not-collapsed">TUTUP</span>
                                              </a>
                                            </td>
                                    ...
                                    <div id="pesan2-2" class="collapse">
                                      <div class="bungkus-detail" style="margin-bottom: 1rem">
                                        <div class="isi-detail">
                                          <div class="row">
                                            <div class="col-sm-6">
